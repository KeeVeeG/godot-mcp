...
export function registerNavigationTools(server: McpServer, bridge: GodotBridge): void {
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'navigation/setup_region', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'navigation/setup_agent', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'navigation/find_path', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'navigation/setup_link', args as Record<string, unknown>),
  );
