 ...
 */
export function pathOnlySchema(pathDescription: string) {
  return {
 ...
 */
export function pathWithPropertiesSchema(pathDescription: string, propertiesDescription = 'Property key-value pairs to set') {
  return {
    path: z.string().describe(pathDescription),
 ...
 */
export function pathWithRequiredPropertiesSchema(pathDescription: string, propertiesDescription: string) {
  return {
    path: z.string().describe(pathDescription),
 ...
 */
export function setPropertySchema(pathDescription: string) {
  return {
    path: z.string().describe(pathDescription),
 ...
 */
export function getPropertySchema(pathDescription: string) {
  return {
    path: z.string().describe(pathDescription),
  };
}
 ...
 */
export function scopedSearchSchema(queryDescription: string) {
  return {
