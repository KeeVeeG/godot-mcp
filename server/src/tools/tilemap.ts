...
export function registerTilemapTools(server: McpServer, bridge: GodotBridge): void {
  // 1. tilemap_set_cell
  server.registerTool(
    'tilemap_set_cell',
    {
    ...
    async (args) => callGodot(bridge, 'tilemap/set_cell', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'tilemap/get_cell', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'tilemap/clear', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'tilemap/get_info', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'gridmap/set_cell', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'gridmap/get_cell', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'gridmap/clear', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'gridmap/get_info', args as Record<string, unknown>),
  );
}
