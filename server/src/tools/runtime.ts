...
export function registerRuntimeTools(server: McpServer, bridge: GodotBridge): void {
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/get_node_properties', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/set_node_property', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/execute_script', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/capture_frames', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/monitor_properties', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/replay_recording', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/find_by_script', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/get_autoload', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/batch_get_properties', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/find_ui_elements', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/click_button', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/wait_for_node', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/find_nearby', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/navigate_to', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/move_to', args as Record<string, unknown>),
  );
  ...
  server.registerTool(
    ...
    async (args) => callGodot(bridge, 'runtime/watch_signals', args as Record<string, unknown>),
  );
}
